...
var addeventatc = (function () {
    ...
    return {
        ...
        generate: function () {
                        ...
                        (d[c].id = a),
                            ...
                            s
                                ? ((d[c].onclick = function () {
                                  ...
                                  (d[c].onmouseover = function () {
                                      clearTimeout(i), addeventatc.toogle(this, { type: "mouseover", id: a });
                                  }),
                            ...
                            (d[c].onkeydown = function (e) {
                                ...
                                ("13" != t && "32" != t && "27" != t && "38" != t && "40" != t) || e.preventDefault(),
                                    ("13" != t && "32" != t) || (addeventatc.keyboardclick(this, { type: "click", id: a }), addeventatc.toogle(this, { type: "click", id: a, keynav: !0 })),
                                    "27" == t && addeventatc.hideandreset(),
                                    "9" == t && addeventatc.hideandreset(),
                                    "38" == t && addeventatc.keyboard(this, { type: "keyboard", id: a, key: "up" }),
                                    "40" == t && addeventatc.keyboard(this, { type: "keyboard", id: a, key: "down" }),
                                    0;
                            }),
                            (d[c].onblur = function () {});
                        var e = d[c];
            ...
            r ? addeventatc.applycss() : (addeventatc.removeelement($d("ate_css")), addeventatc.removeelement($d("ate_tmp_css")), addeventatc.helpercss()), v && !m && ((m = !0), addeventatc.track({ typ: "exposure", cal: "" }));
        },
        toogle: function (e, t) {
            var a,
                n = "",
            ...
            if (c) {
                ...
                if ("outlook" == l || "google" == l || "yahoo" == l || "hotmail" == l || "outlookcom" == l || "appleical" == l || "apple" == l || "facebook" == l)
                    "click" == t.type && (addeventatc.click({ button: d, service: l, id: t.id }), null != S && addeventatc.trigger("button_click", { id: d }));
                else if (("mouseover" == t.type && u != c && (g = !1), "click" == t.type || "render" == t.type || ("mouseover" == t.type && !g))) {
                    "mouseover" == t.type && ((g = !0), null != L && addeventatc.trigger("button_mouseover", { id: d })),
                    ...
                    for (var l, s = (f = (f += ",").replace(/ /gi, "")).split(","), r = 0; r < s.length; r += 1)
                        ((h && "ical" == s[r]) || (h && "appleical" == s[r])) && (n += '<span class="ateappleical" id="' + d + '-appleical" role="menuitem" tabindex="-1">' + N + "</span>"),
                            x && "google" == s[r] && (n += '<span class="ategoogle" id="' + d + '-google" role="menuitem" tabindex="-1">' + z + "</span>"),
                            b && "office365" == s[r] && (n += '<span class="ateoffice365" id="' + d + '-office365" role="menuitem" tabindex="-1">' + E + "</span>"),
                            k && "outlook" == s[r] && (n += '<span class="ateoutlook" id="' + d + '-outlook" role="menuitem" tabindex="-1">' + I + "</span>"),
                            ((y && "hotmail" == s[r]) || (y && "outlookcom" == s[r])) && (n += '<span class="ateoutlookcom" id="' + d + '-outlookcom" role="menuitem" tabindex="-1">' + C + "</span>"),
                            _ && "yahoo" == s[r] && !o && (n += '<span class="ateyahoo" id="' + d + '-yahoo" role="menuitem" tabindex="-1">' + A + "</span>"),
                            a && "facebook" == s[r] && T && "facebook" == s[r] && (n += '<span class="atefacebook" id="' + d + '-facebook" role="menuitem" tabindex="-1">' + $ + "</span>");
                    addeventatc.getlicense(p) || (n += '<em class="copyx"><em class="brx"></em><em class="frs"><a href="https://www.addevent.com" title="" tabindex="-1" id="' + d + '-home">AddEvent.com</a></em></em>'),
                        $d(d + "-drop") ||
                            (((l = document.createElement("span")).id = d + "-drop"), (l.className = "addeventatc_dropdown"), l.setAttribute("aria-hidden", "true"), l.setAttribute("aria-labelledby", d), (l.innerHTML = n), c.appendChild(l)),
                        $d(d + "-appleical") &&
                        ...
                        $d(d + "-outlookcom") &&
                            ($d(d + "-outlookcom").onclick = function () {
                                addeventatc.click({ button: d, service: "outlookcom", id: t.id });
                            }),
                        $d(d + "-yahoo") &&
            ...
            if (d) {
                "home" == e.service
                    ...
                    : ((t = addeventatc.getburl({ id: e.button, facebook: !1 })),
                      (a = "https://www.addevent.com/create/?service=" + e.service + t + "&reference=" + o),
                      ("outlook" != e.service && "appleical" != e.service) || ((n = !1), addeventatc.usewebcal() && (a = "webcal://www.addevent.com/create/?uwc=on&service=" + e.service + t + "&reference=" + o)),
                      null !== (d = d.getAttribute("data-id")) && (a = addeventatc.usewebcal() ? "webcal://www.addevent.com/event/" + d + "+" + e.service + "/?uwc=on" : "https://www.addevent.com/event/" + d + "+" + e.service)),
                    $d("atecllink") ||
                        (((c = document.createElement("a")).id = "atecllink"), (c.rel = "external"), c.setAttribute("data-role", "none"), (c.innerHTML = "{addeventatc-ghost-link}"), (c.style.display = "none"), document.body.appendChild(c));
                var c = $d("atecllink");
                if (((c.target = n ? "_blank" : "_self"), (c.href = a), addeventatc.eclick("atecllink"), addeventatc.track({ typ: "click", cal: e.service }), null != M)) {
        ...
        mouseout: function (e, t) {
            (g = !1), addeventatc.hideandreset(), null != a && addeventatc.trigger("button_mouseout", { id: t.id });
        },
        show: function (e, t) {
            var a,
                n,
            ...
            f &&
                ...
                ("block" == addeventatc.getstyle(h, "display")
                    ...
                    : (addeventatc.hideandreset(!0),
                      ...
                      t.keynav && addeventatc.keyboard(this, { type: "keyboard", id: e, key: "down" }),
                      (a = "auto"),
                      ...
                      "down" == a && "left" == n
                          ...
                          : "auto" == a && "left" == n
                          ? ((u = "0px"), g < s ? ((v = "-2px"), (m = "topdown")) : (v = s + l < g + c ? -(c - o - 2) + "px" : -(c / 2 - o) + "px"))
                          : "auto" == a && "right" == n
                          ? ((u = -(i - d - 2) + "px"), g < s ? ((v = "-2px"), (m = "topdown")) : (v = s + l < g + c ? -(c - o - 2) + "px" : -(c / 2 - o) + "px"))
                          : "down" == a && "auto" == n
                          ? ((u = p < f ? -(i - d - 2) + "px" : "-2px"), (v = "-2px"), (m = "topdown"))
                          : "up" == a && "auto" == n
                          ? ((u = p < f ? -(i - d - 2) + "px" : "-2px"), (v = -(c - o - 2) + "px"))
                          : (g < s ? ((v = "-2px"), (m = "topdown")) : (v = s + l < g + c ? -(c - o - 2) + "px" : -(c / 2 - o) + "px"), (u = p < f ? -(i - d - 2) + "px" : "-2px")),
                      (h.style.left = u),
                      (h.style.top = v),
                      ...
                      "click" == t.type && null != S && addeventatc.trigger("button_click", { id: e }),
                      null != H && addeventatc.trigger("button_dropdown_show", { id: e })));
        },
        hide: function (e) {
            var t = !1;
        ...
        hideandreset: function (e) {
            ...
            e || (null != R && addeventatc.trigger("button_dropdown_hide", { id: t }));
        },
        getburl: function (e) {
            var t = $d(e.id),
                a = "",
            ...
            if (t) {
                for (var o = t.getElementsByTagName("*"), d = 0; d < o.length; d += 1)
                    (addeventatc.hasclass(o[d], "_start") || addeventatc.hasclass(o[d], "start")) && (a += "&dstart=" + encodeURIComponent(o[d].innerHTML)),
                        ...
                        (addeventatc.hasclass(o[d], "_facebook_event") || addeventatc.hasclass(o[d], "facebook_event")) && ((a += "&fbevent=" + encodeURIComponent(o[d].innerHTML)), (n = !0)),
        ...
        applycss: function () {
            ...
            $d("ate_css") && !$d("ate_css_plv") && ($d("ate_css").id = $d("ate_css").id.replace(/ate_css/gi, "ate_css_plv")),
                $d("ate_css") ||
                    ((e = ""),
                    (e += '@import url("https://fonts.googleapis.com/css?family=Open+Sans:400,400i,600");'),
                    (e +=
                    ...
                    (e += ".addeventatc_dropdown .ateappleical \t{background:url(https://www.addevent.com/gfx/icon-apple-t5.svg) 18px 40% no-repeat;background-size:22px 100%;}"),
                    (e += ".addeventatc_dropdown .ategoogle \t\t{background:url(https://www.addevent.com/gfx/icon-google-t5.svg) 18px 50% no-repeat;background-size:22px 100%;}"),
                    (e += ".addeventatc_dropdown .ateoffice365 \t{background:url(https://www.addevent.com/gfx/icon-office365-t5.svg) 19px 50% no-repeat;background-size:18px 100%;}"),
                    (e += ".addeventatc_dropdown .ateoutlook \t\t{background:url(https://www.addevent.com/gfx/icon-outlook-t5.svg) 18px 50% no-repeat;background-size:22px 100%;}"),
                    (e += ".addeventatc_dropdown .ateoutlookcom \t{background:url(https://www.addevent.com/gfx/icon-outlookcom-t5.svg) 18px 50% no-repeat;background-size:22px 100%;}"),
                    (e += ".addeventatc_dropdown .ateyahoo \t\t{background:url(https://www.addevent.com/gfx/icon-yahoo-t5.svg) 18px 50% no-repeat;background-size:22px 100%;}"),
                    (e += ".addeventatc_dropdown .atefacebook \t\t{background:url(https://www.addevent.com/gfx/icon-facebook-t5.svg) 18px 50% no-repeat;background-size:22px 100%;}"),
        ...
        getlicense: function (e) {
            var t,
                ...
                d = !1;
            return (
                void 0 === location.origin && (o = location.protocol + "//" + location.host),
        ...
        getguid: function () {
            ...
            return (
                "" == n &&
                    ((e = (addeventatc.s4() + addeventatc.s4() + "-" + addeventatc.s4() + "-4" + addeventatc.s4().substr(0, 3) + "-" + addeventatc.s4() + "-" + addeventatc.s4() + addeventatc.s4() + addeventatc.s4()).toLowerCase()),
        ...
        settings: function (e) {
            null != e.license && (p = e.license),
                ...
                /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (s = !1),
                null != e.outlook && null != e.outlook.show && (k = e.outlook.show),
                null != e.google && null != e.google.show && (x = e.google.show),
                null != e.office365 && null != e.office365.show && (b = e.office365.show),
                ...
                null != e.outlookcom && null != e.outlookcom.text && (C = e.outlookcom.text),
            ...
            if (a && "block" == addeventatc.getstyle(a, "display")) {
                ...
                for (var l, i = (d = 0); i < n.length; i += 1)
                    ++d == c
                        ...
                        : ((l = new RegExp("(\\s|^)drop_markup(\\s|$)")), (n[i].className = n[i].className.replace(l, " ")), (n[i].className = n[i].className.replace(/\s+$/, "")), (n[i].tabIndex = "-1"));
            }
        },
        ...
        n
            ...
            : (a.push({ fn: e, ctx: t }),
              "complete" === document.readyState || (!document.attachEvent && "interactive" === document.readyState)
                  ? setTimeout(d, 1)
                  : o ||
                    (document.addEventListener ? (document.addEventListener("DOMContentLoaded", d, !1), window.addEventListener("load", d, !1)) : (document.attachEvent("onreadystatechange", c), window.attachEvent("onload", d)), (o = !0)));
    };
})(window);
...
window.addEventListener
    ? (document.addEventListener("click", addeventatc.documentclick, !1), ate_touch_capable && document.addEventListener("touchend", addeventatc.documentclick, !1))
    : window.attachEvent
    ? (document.attachEvent("onclick", addeventatc.documentclick), ate_touch_capable && document.attachEvent("ontouchend", addeventatc.documentclick))
